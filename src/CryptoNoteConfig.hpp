// Copyright (c) 2012-2018, The BrofistCoin developers.
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x7f7b584;
...
const uint64_t MONEY_SUPPLY          = UINT64_C(3990000000000000000);
...
const uint32_t DIFFICULTY_TARGET = 40;  // seconds
...
const int P2P_DEFAULT_PORT        = 13899;
const int RPC_DEFAULT_PORT        = 14899;
const int WALLET_RPC_DEFAULT_PORT = 15899;

const size_t P2P_LOCAL_WHITE_PEERLIST_LIMIT = 1000;
const size_t P2P_LOCAL_GRAY_PEERLIST_LIMIT  = 5000;

const size_t P2P_CONNECTION_MAX_WRITE_BUFFER_SIZE        = 16 * 1024 * 1024;  // 32 Mb
...
const char *const SEED_NODES[] = {
    "37.187.110.214:13899", "209.250.245.204:13899"};
