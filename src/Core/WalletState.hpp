...
class WalletPreparatorMulticore {
	...
	api::brofistcoind::SyncBlocks::Response work;
	int work_counter = 0;
...
public:
	...
	~WalletPreparatorMulticore();
	void cancel_work();
	void start_work(const api::brofistcoind::SyncBlocks::Response &new_work, const SecretKey &view_secret_key);
...
public:
	...
	bool sync_with_blockchain(api::brofistcoind::SyncBlocks::Response &);  // We move from it
	bool sync_with_blockchain(const api::brofistcoind::SyncMemPool::Response &);
