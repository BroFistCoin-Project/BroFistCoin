...
Node::Node(logging::ILogger &log, const Config &config, BlockChainState &block_chain)
	...
	if (!config.brofistcoind_bind_ip.empty() && config.brofistcoind_bind_port != 0)
		m_api.reset(new http::Server(config.brofistcoind_bind_ip, config.brofistcoind_bind_port,
...
void Node::sync_transactions(P2PClientBrofistcoin *who) {
...
void Node::P2PClientBrofistcoin::on_msg_bytes(size_t, size_t) {  // downloaded. uploaded
	//    node->peers.on_peer_bytes(get_address(), downloaded, uploaded,
	//    node->p2p.get_local_time());
}

CORE_SYNC_DATA
Node::P2PClientBrofistcoin::get_sync_data() const {
...
std::vector<PeerlistEntry> Node::P2PClientBrofistcoin::get_peers_to_share() const {
	auto result =
	    m_node->m_peer_db.get_peerlist_to_p2p(m_node->m_p2p.get_local_time(), config.p2p_default_peers_in_handshake);
	return result;
}

void Node::P2PClientBrofistcoin::on_first_message_after_handshake() {
...
void Node::P2PClientBrofistcoin::on_msg_handshake(COMMAND_HANDSHAKE::request &&req) {
	NetworkAddress addr;
...
void Node::P2PClientBrofistcoin::on_msg_handshake(COMMAND_HANDSHAKE::response &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_notify_request_chain(NOTIFY_REQUEST_CHAIN::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_notify_request_chain(NOTIFY_RESPONSE_CHAIN_ENTRY::request &&req) {
	m_node->m_downloader.on_msg_notify_request_chain(this, req);
}

void Node::P2PClientBrofistcoin::on_msg_notify_request_objects(NOTIFY_REQUEST_GET_OBJECTS::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_notify_request_objects(NOTIFY_RESPONSE_GET_OBJECTS::request &&req) {
	m_node->m_downloader.on_msg_notify_request_objects(this, req);
}

void Node::P2PClientBrofistcoin::on_disconnect(const std::string &ban_reason) {
...
void Node::P2PClientBrofistcoin::on_msg_notify_request_tx_pool(NOTIFY_REQUEST_TX_POOL::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_timed_sync(COMMAND_TIMED_SYNC::request &&req) {
	m_node->m_downloader.on_msg_timed_sync(req.payload_data);
}
void Node::P2PClientBrofistcoin::on_msg_timed_sync(COMMAND_TIMED_SYNC::response &&req) {
	m_node->m_downloader.on_msg_timed_sync(req.payload_data);
}

void Node::P2PClientBrofistcoin::on_msg_notify_new_block(NOTIFY_NEW_BLOCK::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_notify_new_transactions(NOTIFY_NEW_TRANSACTIONS::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_network_state(COMMAND_REQUEST_NETWORK_STATE::request &&req) {
...
void Node::P2PClientBrofistcoin::on_msg_stat_info(COMMAND_REQUEST_STAT_INFO::request &&req) {
	if (!m_node->check_trust(req.tr)) {
		disconnect(std::string());
		return;
	}
...
void Node::advance_long_poll() {
	...
	if (m_long_poll_http_clients.empty())
		return;
	api::brofistcoind::GetStatus::Response resp = create_status_response3();
	...
	for (auto lit = m_long_poll_http_clients.begin(); lit != m_long_poll_http_clients.end();) {
		const bool method_status = lit->original_json_request.get_method() == api::brofistcoind::GetStatus::method() ||
		                           lit->original_json_request.get_method() == api::brofistcoind::GetStatus::method2();
		...
		if (method_status) {
			...
			try {
				api::brofistcoind::GetBlockTemplate::Request gbt_req;
				lit->original_json_request.load_params(gbt_req);
				api::brofistcoind::GetBlockTemplate::Response gbt_res;
...
</svg></td><td>brofistcoind &bull; version
)";
...
bool Node::on_api_http_request(http::Client *who, http::RequestData &&request, http::ResponseData &response) {
	...
	if (!m_config.brofistcoind_authorization.empty() &&
	    request.r.basic_authorization != m_config.brofistcoind_authorization) {
...
std::unordered_map<std::string, Node::HTTPHandlerFunction> Node::m_http_handlers = {
    ...
    {api::brofistcoind::SyncBlocks::binMethod(), binMethod2(&Node::on_wallet_sync3)},
    {api::brofistcoind::SyncMemPool::binMethod(), binMethod2(&Node::on_sync_mempool3)},
...
std::unordered_map<std::string, Node::JSONRPCHandlerFunction> Node::m_jsonrpc_handlers = {
    {api::brofistcoind::GetBlockTemplate::method(), json_rpc::makeMemberMethodSeria(&Node::on_getblocktemplate)},
    {api::brofistcoind::GetBlockTemplate::method_legacy(), json_rpc::makeMemberMethodSeria(&Node::on_getblocktemplate)},
    {api::brofistcoind::GetCurrencyId::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_currency_id)},
    {api::brofistcoind::GetCurrencyId::method_legacy(), json_rpc::makeMemberMethodSeria(&Node::on_get_currency_id)},
    {api::brofistcoind::SubmitBlock::method(), json_rpc::makeMemberMethodSeria(&Node::on_submitblock)},
    {api::brofistcoind::SubmitBlockLegacy::method(), json_rpc::makeMemberMethodSeria(&Node::on_submitblock_legacy)},
    {api::brofistcoind::GetRandomOutputs::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_random_outputs3)},
    {api::brofistcoind::GetStatus::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_status3)},
    {api::brofistcoind::GetStatus::method2(), json_rpc::makeMemberMethodSeria(&Node::on_get_status3)},
    {api::brofistcoind::SendTransaction::method(), json_rpc::makeMemberMethodSeria(&Node::handle_send_transaction3)},
    {api::brofistcoind::CheckSendProof::method(), json_rpc::makeMemberMethodSeria(&Node::handle_check_send_proof3)},
    {api::brofistcoind::SyncBlocks::method(), json_rpc::makeMemberMethodSeria(&Node::on_wallet_sync3)},
    {api::brofistcoind::SyncMemPool::method(), json_rpc::makeMemberMethodSeria(&Node::on_sync_mempool3)}};

bool Node::on_get_random_outputs3(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::GetRandomOutputs::Request &&request, api::brofistcoind::GetRandomOutputs::Response &response) {
...
api::brofistcoind::GetStatus::Response Node::create_status_response3() const {
	api::brofistcoind::GetStatus::Response res;
...
bool Node::on_get_status3(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::brofistcoind::GetStatus::Request &&req, api::brofistcoind::GetStatus::Response &res) {
...
bool Node::on_wallet_sync3(http::Client *, http::RequestData &&, json_rpc::Request &&json_req,
    api::brofistcoind::SyncBlocks::Request &&req, api::brofistcoind::SyncBlocks::Response &res) {
	...
	if (req.max_count > api::brofistcoind::SyncBlocks::Request::MAX_COUNT) {
...
bool Node::on_sync_mempool3(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::SyncMemPool::Request &&req, api::brofistcoind::SyncMemPool::Response &res) {
...
bool Node::handle_send_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::SendTransaction::Request &&request, api::brofistcoind::SendTransaction::Response &response) {
	NOTIFY_NEW_TRANSACTIONS::request msg;
	Transaction tx;
...
bool Node::handle_check_send_proof3(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::CheckSendProof::Request &&request, api::brofistcoind::CheckSendProof::Response &response) {
	Transaction tx;
	SendProof sp;
	try {
