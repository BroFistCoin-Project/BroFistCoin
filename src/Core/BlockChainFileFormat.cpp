...
bool LegacyBlockChainReader::import_blockchain2(const std::string &coin_folder, BlockChainState &block_chain) {
	//	std::fstream ts_file("/Users/user/brofistcoin/timestamps.txt",
...
void LegacyBlockChainWriter::write_block(const brofistcoin::RawBlock &raw_block) {
	brofistcoin::BinaryArray ba = seria::to_binary(raw_block);
