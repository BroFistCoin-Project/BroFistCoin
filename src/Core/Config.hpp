...
public:
	...
	std::string brofistcoind_authorization;
	uint16_t brofistcoind_bind_port;
	std::string brofistcoind_bind_ip;
	uint16_t brofistcoind_remote_port;
	std::string brofistcoind_remote_ip;
