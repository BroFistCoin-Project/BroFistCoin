...
void WalletPreparatorMulticore::thread_run() {
	while (true) {
		...
		api::brofistcoind::SyncBlocks::SyncBlock sync_block;
...
void WalletPreparatorMulticore::cancel_work() {
	std::unique_lock<std::mutex> lock(mu);
	work = api::brofistcoind::SyncBlocks::Response();
	prepared_blocks.clear();
	work_counter += 1;
}

void WalletPreparatorMulticore::start_work(const api::brofistcoind::SyncBlocks::Response &new_work,
...
bool WalletState::sync_with_blockchain(api::brofistcoind::SyncBlocks::Response &resp) {
...
bool WalletState::sync_with_blockchain(const api::brofistcoind::SyncMemPool::Response &resp) {
