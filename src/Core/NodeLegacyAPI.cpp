...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::brofistcoind::GetBlockTemplate::Request &&req, api::brofistcoind::GetBlockTemplate::Response &res) {
	api::brofistcoind::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::brofistcoind::GetBlockTemplate::Request &req,
    api::brofistcoind::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::GetCurrencyId::Request && /*req*/, api::brofistcoind::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::brofistcoind::SubmitBlock::Request &&req, api::brofistcoind::SubmitBlock::Response &res) {
...
bool Node::on_submitblock_legacy(http::Client *who, http::RequestData &&rd, json_rpc::Request &&jr,
    api::brofistcoind::SubmitBlockLegacy::Request &&req, api::brofistcoind::SubmitBlockLegacy::Response &res) {
	if (req.size() != 1) {
		throw json_rpc::Error{CORE_RPC_ERROR_CODE_WRONG_PARAM, "Wrong param"};
	}

	api::brofistcoind::SubmitBlock::Request other_req;
